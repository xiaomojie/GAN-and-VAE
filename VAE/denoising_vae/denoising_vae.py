...
# 其实就是vae，加上了噪声,原理可以参照：https://www.cnblogs.com/huangshiyu13/p/6209016.html
...
"""对于我们的损失函数，我们可以把这两方面进行加和。一方面，是图片的重构误差，我们可以用平均平方误差来度量，另一方面。我们可以用KL散度（KL散度介绍）来度量我们潜在变量的分布和单位高斯分布的差异。"""
# E[log P(X|z)]
